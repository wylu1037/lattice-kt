...
class GenerateTransactionsTest {
    ...
    object Constants {
        ...
        internal const val COUNTER_ADDRESS = "zltc_dDJRmE83F4yKPmYLJ4nEQj3ppjFF9Hg2G" // 计数器合约地址
    ...
    fun `deploy counter contract`() {
        ...
        val receipt = lattice.deployContractWaitReceipt(Constants.CHAIN_ID, bytecode, version = TxVersionEnum.V_3_0)
        println(gson.toJson(receipt))
    }

    @Test
    fun `concurrent generate signed call contract transactions`() {
        val contractAddress = "zltc_dDJRmE83F4yKPmYLJ4nEQj3ppjFF9Hg2G"
